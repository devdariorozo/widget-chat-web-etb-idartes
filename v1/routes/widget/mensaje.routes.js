...
// router.post('/crearSoulChat', crearMensajeSoulChatLimiter, upload.single('adjuntos'), validator.crearSoulChat, controller.crearSoulChat);
// router.post('/crearSoulChat', crearMensajeSoulChatLimiter, upload.array('adjuntos', 5), validator.crearSoulChat, controller.crearSoulChat);
router.post('/crearSoulChat', crearMensajeSoulChatLimiter, upload.fields([
    { name: 'file', maxCount: 5 },
    { name: 'files', maxCount: 5 }
]), validator.crearSoulChat, controller.crearSoulChat);

// TODO: CREAR MENSAJE DESDE SOUL CHAT - PASO WIDGET ARBOL ENCUESTA
// router.post('/encuestaSoulChat', crearMensajeSoulChatEncuestaLimiter, upload.single('adjuntos'), validator.encuestaSoulChat, controller.encuestaSoulChat);
