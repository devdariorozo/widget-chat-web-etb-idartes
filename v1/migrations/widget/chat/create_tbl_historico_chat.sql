...
CREATE TABLE `tbl_historico_chat` (
  ...
  `htcht_calificar_servicio` varchar(45) NOT NULL DEFAULT '-',
  `htcht_calificar_amabilidad` varchar(45) NOT NULL DEFAULT '-',
  `htcht_calificar_tiempo` varchar(45) NOT NULL DEFAULT '-',
  `htcht_calificar_calidad` varchar(45) NOT NULL DEFAULT '-',
  `htcht_calificar_conocimiento` varchar(45) NOT NULL DEFAULT '-',
  `htcht_calificar_solucion` varchar(45) NOT NULL DEFAULT '-',
  `htcht_comentario` varchar(1000) NOT NULL DEFAULT '-',
