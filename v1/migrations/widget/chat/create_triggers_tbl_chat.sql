...
BEGIN
    INSERT INTO tbl_historico_chat (
        ...
        htcht_calificar_servicio,
        htcht_calificar_amabilidad,
        htcht_calificar_tiempo,
        htcht_calificar_calidad,
        htcht_calificar_conocimiento,
        htcht_calificar_solucion,
        htcht_comentario,
        htcht_descripcion,
        htcht_registro,
        htcht_actualizacion,
        ...
        NEW.cht_calificar_servicio,
        NEW.cht_calificar_amabilidad,
        NEW.cht_calificar_tiempo,
        NEW.cht_calificar_calidad,
        NEW.cht_calificar_conocimiento,
        NEW.cht_calificar_solucion,
        NEW.cht_comentario,
        NEW.cht_descripcion,
        NEW.cht_registro,
...
BEGIN
    INSERT INTO tbl_historico_chat (
        ...
        OLD.cht_calificar_servicio,
        OLD.cht_calificar_amabilidad,
        OLD.cht_calificar_tiempo,
        OLD.cht_calificar_calidad,
        OLD.cht_calificar_conocimiento,
        OLD.cht_calificar_solucion,
        OLD.cht_comentario,
        OLD.cht_descripcion,
        OLD.cht_registro,
