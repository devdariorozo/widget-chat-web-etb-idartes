...
const formularioInicial = [
    ...
    body('camposFormulario.nombresApellidos')
        .trim()
        .notEmpty().withMessage('El campo "Nombres y Apellidos" no puede estar vacío...'),

    body('camposFormulario.genero')
        .trim()
    ...
    body('camposFormulario.localidad')
        .trim()
        .notEmpty().withMessage('El campo "Localidad" no puede estar vacío...'),

    body('camposFormulario.rangoEdad')
        .trim()
        .notEmpty().withMessage('El campo "Rango de Edad" no puede estar vacío...'),

    body('camposFormulario.temaConsulta')
        .trim()
        .notEmpty().withMessage('El campo "Tema de consulta" no puede estar vacío...'),
